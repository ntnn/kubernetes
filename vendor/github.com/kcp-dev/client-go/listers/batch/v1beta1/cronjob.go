...
func (l *cronJobClusterLister) Cluster(clusterName logicalcluster.Name) listersbatchv1beta1.CronJobLister {
	return &cronJobLister{
		kcplisters.New[*batchv1beta1.CronJob](l.indexer, clusterName, batchv1beta1.Resource("cronjob")),
		l.indexer,
		clusterName,
	}
}
...
func (l *cronJobLister) CronJobs(namespace string) listersbatchv1beta1.CronJobNamespaceLister {
	return newCronJobNamespaceLister(l.ResourceIndexer, namespace)
}
...
// newCronJobNamespaceLister returns a new listersbatchv1beta1.CronJobNamespaceLister.
func newCronJobNamespaceLister(indexer kcplisters.ResourceIndexer[*batchv1beta1.CronJob], namespace string) listersbatchv1beta1.CronJobNamespaceLister {
	return &cronJobNamespaceLister{
		kcplisters.NewNamespaced(indexer, namespace),
	}
}

// NewCronJobLister returns a new listersbatchv1beta1.CronJobLister.
// We assume that the indexer:
// - is fed by a workspace-scoped LIST+WATCH
// - uses cache.MetaNamespaceKeyFunc as the key function
// - has the cache.NamespaceIndex as an index
func NewCronJobLister(indexer cache.Indexer) listersbatchv1beta1.CronJobLister {
	return &cronJobScopedLister{
		listers.New[*batchv1beta1.CronJob](indexer, batchv1beta1.Resource("cronjob")),
		indexer,
	}
}
...
// CronJobs returns an object that can list and get CronJobs in one namespace.
func (l *cronJobScopedLister) CronJobs(namespace string) listersbatchv1beta1.CronJobNamespaceLister {
