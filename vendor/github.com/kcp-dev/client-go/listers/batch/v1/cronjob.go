...
func (l *cronJobClusterLister) Cluster(clusterName logicalcluster.Name) listersbatchv1.CronJobLister {
	return &cronJobLister{
		kcplisters.New[*batchv1.CronJob](l.indexer, clusterName, batchv1.Resource("cronjob")),
		l.indexer,
		clusterName,
	}
}
...
// newCronJobNamespaceLister returns a new listersbatchv1.CronJobNamespaceLister.
func newCronJobNamespaceLister(indexer kcplisters.ResourceIndexer[*batchv1.CronJob], namespace string) listersbatchv1.CronJobNamespaceLister {
	return &cronJobNamespaceLister{
		kcplisters.NewNamespaced(indexer, namespace),
	}
}

// NewCronJobLister returns a new listersbatchv1.CronJobLister.
// We assume that the indexer:
...
func NewCronJobLister(indexer cache.Indexer) listersbatchv1.CronJobLister {
	return &cronJobScopedLister{
		listers.New[*batchv1.CronJob](indexer, batchv1.Resource("cronjob")),
		indexer,
	}
}
...
// CronJobs returns an object that can list and get CronJobs in one namespace.
func (l *cronJobScopedLister) CronJobs(namespace string) listersbatchv1.CronJobNamespaceLister {
