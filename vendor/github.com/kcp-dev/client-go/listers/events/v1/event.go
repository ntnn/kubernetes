...
func (l *eventClusterLister) Cluster(clusterName logicalcluster.Name) listerseventsv1.EventLister {
	return &eventLister{
		kcplisters.New[*eventsv1.Event](l.indexer, clusterName, eventsv1.Resource("event")),
		l.indexer,
		clusterName,
	}
}
...
// newEventNamespaceLister returns a new listerseventsv1.EventNamespaceLister.
func newEventNamespaceLister(indexer kcplisters.ResourceIndexer[*eventsv1.Event], namespace string) listerseventsv1.EventNamespaceLister {
	return &eventNamespaceLister{
		kcplisters.NewNamespaced(indexer, namespace),
	}
}

// NewEventLister returns a new listerseventsv1.EventLister.
// We assume that the indexer:
...
func NewEventLister(indexer cache.Indexer) listerseventsv1.EventLister {
	return &eventScopedLister{
		listers.New[*eventsv1.Event](indexer, eventsv1.Resource("event")),
		indexer,
	}
}
...
// Events returns an object that can list and get Events in one namespace.
func (l *eventScopedLister) Events(namespace string) listerseventsv1.EventNamespaceLister {
