...
func (l *validatingAdmissionPolicyBindingClusterLister) Cluster(clusterName logicalcluster.Name) listersadmissionregistrationv1beta1.ValidatingAdmissionPolicyBindingLister {
	return &validatingAdmissionPolicyBindingLister{
		kcplisters.New[*admissionregistrationv1beta1.ValidatingAdmissionPolicyBinding](l.indexer, clusterName, admissionregistrationv1beta1.Resource("validatingadmissionpolicybinding")),
		l.indexer,
		clusterName,
	}
}
...
// NewValidatingAdmissionPolicyBindingLister returns a new listersadmissionregistrationv1beta1.ValidatingAdmissionPolicyBindingLister.
// We assume that the indexer:
...
func NewValidatingAdmissionPolicyBindingLister(indexer cache.Indexer) listersadmissionregistrationv1beta1.ValidatingAdmissionPolicyBindingLister {
	return &validatingAdmissionPolicyBindingScopedLister{
		listers.New[*admissionregistrationv1beta1.ValidatingAdmissionPolicyBinding](indexer, admissionregistrationv1beta1.Resource("validatingadmissionpolicybinding")),
		indexer,
	}
}
