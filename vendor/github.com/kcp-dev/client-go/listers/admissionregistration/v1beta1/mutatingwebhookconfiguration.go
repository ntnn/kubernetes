...
func (l *mutatingWebhookConfigurationClusterLister) Cluster(clusterName logicalcluster.Name) listersadmissionregistrationv1beta1.MutatingWebhookConfigurationLister {
	return &mutatingWebhookConfigurationLister{
		kcplisters.New[*admissionregistrationv1beta1.MutatingWebhookConfiguration](l.indexer, clusterName, admissionregistrationv1beta1.Resource("mutatingwebhookconfiguration")),
		l.indexer,
		clusterName,
	}
}
...
// NewMutatingWebhookConfigurationLister returns a new listersadmissionregistrationv1beta1.MutatingWebhookConfigurationLister.
// We assume that the indexer:
...
func NewMutatingWebhookConfigurationLister(indexer cache.Indexer) listersadmissionregistrationv1beta1.MutatingWebhookConfigurationLister {
	return &mutatingWebhookConfigurationScopedLister{
		listers.New[*admissionregistrationv1beta1.MutatingWebhookConfiguration](indexer, admissionregistrationv1beta1.Resource("mutatingwebhookconfiguration")),
		indexer,
	}
}
