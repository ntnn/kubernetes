...
func (l *validatingWebhookConfigurationClusterLister) Cluster(clusterName logicalcluster.Name) listersadmissionregistrationv1beta1.ValidatingWebhookConfigurationLister {
	return &validatingWebhookConfigurationLister{
		kcplisters.New[*admissionregistrationv1beta1.ValidatingWebhookConfiguration](l.indexer, clusterName, admissionregistrationv1beta1.Resource("validatingwebhookconfiguration")),
		l.indexer,
		clusterName,
	}
}
...
// NewValidatingWebhookConfigurationLister returns a new listersadmissionregistrationv1beta1.ValidatingWebhookConfigurationLister.
// We assume that the indexer:
...
func NewValidatingWebhookConfigurationLister(indexer cache.Indexer) listersadmissionregistrationv1beta1.ValidatingWebhookConfigurationLister {
	return &validatingWebhookConfigurationScopedLister{
		listers.New[*admissionregistrationv1beta1.ValidatingWebhookConfiguration](indexer, admissionregistrationv1beta1.Resource("validatingwebhookconfiguration")),
		indexer,
	}
}
