...
func (l *validatingAdmissionPolicyClusterLister) Cluster(clusterName logicalcluster.Name) listersadmissionregistrationv1beta1.ValidatingAdmissionPolicyLister {
	return &validatingAdmissionPolicyLister{
		kcplisters.New[*admissionregistrationv1beta1.ValidatingAdmissionPolicy](l.indexer, clusterName, admissionregistrationv1beta1.Resource("validatingadmissionpolicy")),
		l.indexer,
		clusterName,
	}
}
...
// NewValidatingAdmissionPolicyLister returns a new listersadmissionregistrationv1beta1.ValidatingAdmissionPolicyLister.
// We assume that the indexer:
...
func NewValidatingAdmissionPolicyLister(indexer cache.Indexer) listersadmissionregistrationv1beta1.ValidatingAdmissionPolicyLister {
	return &validatingAdmissionPolicyScopedLister{
		listers.New[*admissionregistrationv1beta1.ValidatingAdmissionPolicy](indexer, admissionregistrationv1beta1.Resource("validatingadmissionpolicy")),
		indexer,
	}
}
