...
func (l *validatingAdmissionPolicyClusterLister) Cluster(clusterName logicalcluster.Name) listersadmissionregistrationv1.ValidatingAdmissionPolicyLister {
	return &validatingAdmissionPolicyLister{
		kcplisters.New[*admissionregistrationv1.ValidatingAdmissionPolicy](l.indexer, clusterName, admissionregistrationv1.Resource("validatingadmissionpolicy")),
		l.indexer,
		clusterName,
	}
}
...
// NewValidatingAdmissionPolicyLister returns a new listersadmissionregistrationv1.ValidatingAdmissionPolicyLister.
// We assume that the indexer:
...
func NewValidatingAdmissionPolicyLister(indexer cache.Indexer) listersadmissionregistrationv1.ValidatingAdmissionPolicyLister {
	return &validatingAdmissionPolicyScopedLister{
		listers.New[*admissionregistrationv1.ValidatingAdmissionPolicy](indexer, admissionregistrationv1.Resource("validatingadmissionpolicy")),
		indexer,
	}
}
