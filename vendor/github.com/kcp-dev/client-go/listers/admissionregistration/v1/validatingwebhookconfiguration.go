...
func (l *validatingWebhookConfigurationClusterLister) Cluster(clusterName logicalcluster.Name) listersadmissionregistrationv1.ValidatingWebhookConfigurationLister {
	return &validatingWebhookConfigurationLister{
		kcplisters.New[*admissionregistrationv1.ValidatingWebhookConfiguration](l.indexer, clusterName, admissionregistrationv1.Resource("validatingwebhookconfiguration")),
		l.indexer,
		clusterName,
	}
}
...
// NewValidatingWebhookConfigurationLister returns a new listersadmissionregistrationv1.ValidatingWebhookConfigurationLister.
// We assume that the indexer:
...
func NewValidatingWebhookConfigurationLister(indexer cache.Indexer) listersadmissionregistrationv1.ValidatingWebhookConfigurationLister {
	return &validatingWebhookConfigurationScopedLister{
		listers.New[*admissionregistrationv1.ValidatingWebhookConfiguration](indexer, admissionregistrationv1.Resource("validatingwebhookconfiguration")),
		indexer,
	}
}
