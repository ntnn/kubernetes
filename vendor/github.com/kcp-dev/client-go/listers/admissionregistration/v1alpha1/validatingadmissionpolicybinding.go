...
func (l *validatingAdmissionPolicyBindingClusterLister) Cluster(clusterName logicalcluster.Name) listersadmissionregistrationv1alpha1.ValidatingAdmissionPolicyBindingLister {
	return &validatingAdmissionPolicyBindingLister{
		kcplisters.New[*admissionregistrationv1alpha1.ValidatingAdmissionPolicyBinding](l.indexer, clusterName, admissionregistrationv1alpha1.Resource("validatingadmissionpolicybinding")),
		l.indexer,
		clusterName,
	}
}
...
// NewValidatingAdmissionPolicyBindingLister returns a new listersadmissionregistrationv1alpha1.ValidatingAdmissionPolicyBindingLister.
// We assume that the indexer:
...
func NewValidatingAdmissionPolicyBindingLister(indexer cache.Indexer) listersadmissionregistrationv1alpha1.ValidatingAdmissionPolicyBindingLister {
	return &validatingAdmissionPolicyBindingScopedLister{
		listers.New[*admissionregistrationv1alpha1.ValidatingAdmissionPolicyBinding](indexer, admissionregistrationv1alpha1.Resource("validatingadmissionpolicybinding")),
		indexer,
	}
}
