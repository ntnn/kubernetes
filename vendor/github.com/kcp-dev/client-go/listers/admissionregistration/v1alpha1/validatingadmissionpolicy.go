...
func (l *validatingAdmissionPolicyClusterLister) Cluster(clusterName logicalcluster.Name) listersadmissionregistrationv1alpha1.ValidatingAdmissionPolicyLister {
	return &validatingAdmissionPolicyLister{
		kcplisters.New[*admissionregistrationv1alpha1.ValidatingAdmissionPolicy](l.indexer, clusterName, admissionregistrationv1alpha1.Resource("validatingadmissionpolicy")),
		l.indexer,
		clusterName,
	}
}
...
// NewValidatingAdmissionPolicyLister returns a new listersadmissionregistrationv1alpha1.ValidatingAdmissionPolicyLister.
// We assume that the indexer:
...
func NewValidatingAdmissionPolicyLister(indexer cache.Indexer) listersadmissionregistrationv1alpha1.ValidatingAdmissionPolicyLister {
	return &validatingAdmissionPolicyScopedLister{
		listers.New[*admissionregistrationv1alpha1.ValidatingAdmissionPolicy](indexer, admissionregistrationv1alpha1.Resource("validatingadmissionpolicy")),
		indexer,
	}
}
