...
func (l *mutatingAdmissionPolicyClusterLister) Cluster(clusterName logicalcluster.Name) listersadmissionregistrationv1alpha1.MutatingAdmissionPolicyLister {
	return &mutatingAdmissionPolicyLister{
		kcplisters.New[*admissionregistrationv1alpha1.MutatingAdmissionPolicy](l.indexer, clusterName, admissionregistrationv1alpha1.Resource("mutatingadmissionpolicy")),
		l.indexer,
		clusterName,
	}
}
...
// NewMutatingAdmissionPolicyLister returns a new listersadmissionregistrationv1alpha1.MutatingAdmissionPolicyLister.
// We assume that the indexer:
...
func NewMutatingAdmissionPolicyLister(indexer cache.Indexer) listersadmissionregistrationv1alpha1.MutatingAdmissionPolicyLister {
	return &mutatingAdmissionPolicyScopedLister{
		listers.New[*admissionregistrationv1alpha1.MutatingAdmissionPolicy](indexer, admissionregistrationv1alpha1.Resource("mutatingadmissionpolicy")),
		indexer,
	}
}
