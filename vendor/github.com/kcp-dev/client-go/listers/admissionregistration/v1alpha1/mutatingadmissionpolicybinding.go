...
func (l *mutatingAdmissionPolicyBindingClusterLister) Cluster(clusterName logicalcluster.Name) listersadmissionregistrationv1alpha1.MutatingAdmissionPolicyBindingLister {
	return &mutatingAdmissionPolicyBindingLister{
		kcplisters.New[*admissionregistrationv1alpha1.MutatingAdmissionPolicyBinding](l.indexer, clusterName, admissionregistrationv1alpha1.Resource("mutatingadmissionpolicybinding")),
		l.indexer,
		clusterName,
	}
}
...
// NewMutatingAdmissionPolicyBindingLister returns a new listersadmissionregistrationv1alpha1.MutatingAdmissionPolicyBindingLister.
// We assume that the indexer:
...
func NewMutatingAdmissionPolicyBindingLister(indexer cache.Indexer) listersadmissionregistrationv1alpha1.MutatingAdmissionPolicyBindingLister {
	return &mutatingAdmissionPolicyBindingScopedLister{
		listers.New[*admissionregistrationv1alpha1.MutatingAdmissionPolicyBinding](indexer, admissionregistrationv1alpha1.Resource("mutatingadmissionpolicybinding")),
		indexer,
	}
}
