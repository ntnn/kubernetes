...
func (l *podDisruptionBudgetClusterLister) Cluster(clusterName logicalcluster.Name) listerspolicyv1.PodDisruptionBudgetLister {
	return &podDisruptionBudgetLister{
		kcplisters.New[*policyv1.PodDisruptionBudget](l.indexer, clusterName, policyv1.Resource("poddisruptionbudget")),
		l.indexer,
		clusterName,
	}
}
...
// newPodDisruptionBudgetNamespaceLister returns a new listerspolicyv1.PodDisruptionBudgetNamespaceLister.
func newPodDisruptionBudgetNamespaceLister(indexer kcplisters.ResourceIndexer[*policyv1.PodDisruptionBudget], namespace string) listerspolicyv1.PodDisruptionBudgetNamespaceLister {
	return &podDisruptionBudgetNamespaceLister{
		kcplisters.NewNamespaced(indexer, namespace),
	}
}

// NewPodDisruptionBudgetLister returns a new listerspolicyv1.PodDisruptionBudgetLister.
// We assume that the indexer:
...
// PodDisruptionBudgets returns an object that can list and get PodDisruptionBudgets in one namespace.
func (l *podDisruptionBudgetScopedLister) PodDisruptionBudgets(namespace string) listerspolicyv1.PodDisruptionBudgetNamespaceLister {
