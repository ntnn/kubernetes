...
func (l *evictionClusterLister) Cluster(clusterName logicalcluster.Name) listerspolicyv1.EvictionLister {
	return &evictionLister{
		kcplisters.New[*policyv1.Eviction](l.indexer, clusterName, policyv1.Resource("eviction")),
		l.indexer,
		clusterName,
	}
}
...
// newEvictionNamespaceLister returns a new listerspolicyv1.EvictionNamespaceLister.
func newEvictionNamespaceLister(indexer kcplisters.ResourceIndexer[*policyv1.Eviction], namespace string) listerspolicyv1.EvictionNamespaceLister {
	return &evictionNamespaceLister{
		kcplisters.NewNamespaced(indexer, namespace),
	}
}

// NewEvictionLister returns a new listerspolicyv1.EvictionLister.
// We assume that the indexer:
...
func NewEvictionLister(indexer cache.Indexer) listerspolicyv1.EvictionLister {
	return &evictionScopedLister{
		listers.New[*policyv1.Eviction](indexer, policyv1.Resource("eviction")),
		indexer,
	}
}
...
// Evictions returns an object that can list and get Evictions in one namespace.
func (l *evictionScopedLister) Evictions(namespace string) listerspolicyv1.EvictionNamespaceLister {
