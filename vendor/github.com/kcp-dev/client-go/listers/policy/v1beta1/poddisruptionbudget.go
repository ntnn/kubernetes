...
func (l *podDisruptionBudgetClusterLister) Cluster(clusterName logicalcluster.Name) listerspolicyv1beta1.PodDisruptionBudgetLister {
	return &podDisruptionBudgetLister{
		kcplisters.New[*policyv1beta1.PodDisruptionBudget](l.indexer, clusterName, policyv1beta1.Resource("poddisruptionbudget")),
		l.indexer,
		clusterName,
	}
}
...
func (l *podDisruptionBudgetLister) PodDisruptionBudgets(namespace string) listerspolicyv1beta1.PodDisruptionBudgetNamespaceLister {
	return newPodDisruptionBudgetNamespaceLister(l.ResourceIndexer, namespace)
}
...
// newPodDisruptionBudgetNamespaceLister returns a new listerspolicyv1beta1.PodDisruptionBudgetNamespaceLister.
func newPodDisruptionBudgetNamespaceLister(indexer kcplisters.ResourceIndexer[*policyv1beta1.PodDisruptionBudget], namespace string) listerspolicyv1beta1.PodDisruptionBudgetNamespaceLister {
	return &podDisruptionBudgetNamespaceLister{
		kcplisters.NewNamespaced(indexer, namespace),
	}
}

// NewPodDisruptionBudgetLister returns a new listerspolicyv1beta1.PodDisruptionBudgetLister.
// We assume that the indexer:
...
func NewPodDisruptionBudgetLister(indexer cache.Indexer) listerspolicyv1beta1.PodDisruptionBudgetLister {
	return &podDisruptionBudgetScopedLister{
		listers.New[*policyv1beta1.PodDisruptionBudget](indexer, policyv1beta1.Resource("poddisruptionbudget")),
		indexer,
	}
}
...
// PodDisruptionBudgets returns an object that can list and get PodDisruptionBudgets in one namespace.
func (l *podDisruptionBudgetScopedLister) PodDisruptionBudgets(namespace string) listerspolicyv1beta1.PodDisruptionBudgetNamespaceLister {
