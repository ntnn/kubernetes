...
func (l *evictionClusterLister) Cluster(clusterName logicalcluster.Name) listerspolicyv1beta1.EvictionLister {
	return &evictionLister{
		kcplisters.New[*policyv1beta1.Eviction](l.indexer, clusterName, policyv1beta1.Resource("eviction")),
		l.indexer,
		clusterName,
	}
}
...
func (l *evictionLister) Evictions(namespace string) listerspolicyv1beta1.EvictionNamespaceLister {
	return newEvictionNamespaceLister(l.ResourceIndexer, namespace)
}
...
// newEvictionNamespaceLister returns a new listerspolicyv1beta1.EvictionNamespaceLister.
func newEvictionNamespaceLister(indexer kcplisters.ResourceIndexer[*policyv1beta1.Eviction], namespace string) listerspolicyv1beta1.EvictionNamespaceLister {
	return &evictionNamespaceLister{
		kcplisters.NewNamespaced(indexer, namespace),
	}
}

// NewEvictionLister returns a new listerspolicyv1beta1.EvictionLister.
// We assume that the indexer:
// - is fed by a workspace-scoped LIST+WATCH
// - uses cache.MetaNamespaceKeyFunc as the key function
// - has the cache.NamespaceIndex as an index
func NewEvictionLister(indexer cache.Indexer) listerspolicyv1beta1.EvictionLister {
	return &evictionScopedLister{
		listers.New[*policyv1beta1.Eviction](indexer, policyv1beta1.Resource("eviction")),
		indexer,
	}
}
...
// Evictions returns an object that can list and get Evictions in one namespace.
func (l *evictionScopedLister) Evictions(namespace string) listerspolicyv1beta1.EvictionNamespaceLister {
