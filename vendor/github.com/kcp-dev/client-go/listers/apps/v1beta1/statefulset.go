...
func (l *statefulSetClusterLister) Cluster(clusterName logicalcluster.Name) listersappsv1beta1.StatefulSetLister {
	return &statefulSetLister{
		kcplisters.New[*appsv1beta1.StatefulSet](l.indexer, clusterName, appsv1beta1.Resource("statefulset")),
		l.indexer,
		clusterName,
	}
}
...
// newStatefulSetNamespaceLister returns a new listersappsv1beta1.StatefulSetNamespaceLister.
func newStatefulSetNamespaceLister(indexer kcplisters.ResourceIndexer[*appsv1beta1.StatefulSet], namespace string) listersappsv1beta1.StatefulSetNamespaceLister {
	return &statefulSetNamespaceLister{
		kcplisters.NewNamespaced(indexer, namespace),
	}
}

// NewStatefulSetLister returns a new listersappsv1beta1.StatefulSetLister.
// We assume that the indexer:
...
func NewStatefulSetLister(indexer cache.Indexer) listersappsv1beta1.StatefulSetLister {
	return &statefulSetScopedLister{
		listers.New[*appsv1beta1.StatefulSet](indexer, appsv1beta1.Resource("statefulset")),
		indexer,
	}
}
...
// StatefulSets returns an object that can list and get StatefulSets in one namespace.
func (l *statefulSetScopedLister) StatefulSets(namespace string) listersappsv1beta1.StatefulSetNamespaceLister {
