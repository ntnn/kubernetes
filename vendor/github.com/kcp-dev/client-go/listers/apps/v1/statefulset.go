...
func (l *statefulSetClusterLister) Cluster(clusterName logicalcluster.Name) listersappsv1.StatefulSetLister {
	return &statefulSetLister{
		kcplisters.New[*appsv1.StatefulSet](l.indexer, clusterName, appsv1.Resource("statefulset")),
		l.indexer,
		clusterName,
	}
}
...
// newStatefulSetNamespaceLister returns a new listersappsv1.StatefulSetNamespaceLister.
func newStatefulSetNamespaceLister(indexer kcplisters.ResourceIndexer[*appsv1.StatefulSet], namespace string) listersappsv1.StatefulSetNamespaceLister {
	return &statefulSetNamespaceLister{
		kcplisters.NewNamespaced(indexer, namespace),
	}
}

// NewStatefulSetLister returns a new listersappsv1.StatefulSetLister.
// We assume that the indexer:
...
func NewStatefulSetLister(indexer cache.Indexer) listersappsv1.StatefulSetLister {
	return &statefulSetScopedLister{
		listers.New[*appsv1.StatefulSet](indexer, appsv1.Resource("statefulset")),
		indexer,
	}
}
...
// StatefulSets returns an object that can list and get StatefulSets in one namespace.
func (l *statefulSetScopedLister) StatefulSets(namespace string) listersappsv1.StatefulSetNamespaceLister {
