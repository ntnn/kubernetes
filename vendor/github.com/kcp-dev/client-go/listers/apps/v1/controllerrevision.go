...
func (l *controllerRevisionClusterLister) Cluster(clusterName logicalcluster.Name) listersappsv1.ControllerRevisionLister {
	return &controllerRevisionLister{
		kcplisters.New[*appsv1.ControllerRevision](l.indexer, clusterName, appsv1.Resource("controllerrevision")),
		l.indexer,
		clusterName,
	}
}
...
// newControllerRevisionNamespaceLister returns a new listersappsv1.ControllerRevisionNamespaceLister.
func newControllerRevisionNamespaceLister(indexer kcplisters.ResourceIndexer[*appsv1.ControllerRevision], namespace string) listersappsv1.ControllerRevisionNamespaceLister {
	return &controllerRevisionNamespaceLister{
		kcplisters.NewNamespaced(indexer, namespace),
	}
}

// NewControllerRevisionLister returns a new listersappsv1.ControllerRevisionLister.
// We assume that the indexer:
...
func NewControllerRevisionLister(indexer cache.Indexer) listersappsv1.ControllerRevisionLister {
	return &controllerRevisionScopedLister{
		listers.New[*appsv1.ControllerRevision](indexer, appsv1.Resource("controllerrevision")),
		indexer,
	}
}
...
// ControllerRevisions returns an object that can list and get ControllerRevisions in one namespace.
func (l *controllerRevisionScopedLister) ControllerRevisions(namespace string) listersappsv1.ControllerRevisionNamespaceLister {
