...
func (l *daemonSetClusterLister) Cluster(clusterName logicalcluster.Name) listersappsv1.DaemonSetLister {
	return &daemonSetLister{
		kcplisters.New[*appsv1.DaemonSet](l.indexer, clusterName, appsv1.Resource("daemonset")),
		l.indexer,
		clusterName,
	}
}
...
// newDaemonSetNamespaceLister returns a new listersappsv1.DaemonSetNamespaceLister.
func newDaemonSetNamespaceLister(indexer kcplisters.ResourceIndexer[*appsv1.DaemonSet], namespace string) listersappsv1.DaemonSetNamespaceLister {
	return &daemonSetNamespaceLister{
		kcplisters.NewNamespaced(indexer, namespace),
	}
}

// NewDaemonSetLister returns a new listersappsv1.DaemonSetLister.
// We assume that the indexer:
...
func NewDaemonSetLister(indexer cache.Indexer) listersappsv1.DaemonSetLister {
	return &daemonSetScopedLister{
		listers.New[*appsv1.DaemonSet](indexer, appsv1.Resource("daemonset")),
		indexer,
	}
}
...
// DaemonSets returns an object that can list and get DaemonSets in one namespace.
func (l *daemonSetScopedLister) DaemonSets(namespace string) listersappsv1.DaemonSetNamespaceLister {
