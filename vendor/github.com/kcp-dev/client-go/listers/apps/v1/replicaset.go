...
func (l *replicaSetClusterLister) Cluster(clusterName logicalcluster.Name) listersappsv1.ReplicaSetLister {
	return &replicaSetLister{
		kcplisters.New[*appsv1.ReplicaSet](l.indexer, clusterName, appsv1.Resource("replicaset")),
		l.indexer,
		clusterName,
	}
}
...
// newReplicaSetNamespaceLister returns a new listersappsv1.ReplicaSetNamespaceLister.
func newReplicaSetNamespaceLister(indexer kcplisters.ResourceIndexer[*appsv1.ReplicaSet], namespace string) listersappsv1.ReplicaSetNamespaceLister {
	return &replicaSetNamespaceLister{
		kcplisters.NewNamespaced(indexer, namespace),
	}
}

// NewReplicaSetLister returns a new listersappsv1.ReplicaSetLister.
// We assume that the indexer:
...
func NewReplicaSetLister(indexer cache.Indexer) listersappsv1.ReplicaSetLister {
	return &replicaSetScopedLister{
		listers.New[*appsv1.ReplicaSet](indexer, appsv1.Resource("replicaset")),
		indexer,
	}
}
...
// ReplicaSets returns an object that can list and get ReplicaSets in one namespace.
func (l *replicaSetScopedLister) ReplicaSets(namespace string) listersappsv1.ReplicaSetNamespaceLister {
