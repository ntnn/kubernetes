...
func (l *deploymentClusterLister) Cluster(clusterName logicalcluster.Name) listersappsv1.DeploymentLister {
	return &deploymentLister{
		kcplisters.New[*appsv1.Deployment](l.indexer, clusterName, appsv1.Resource("deployment")),
		l.indexer,
		clusterName,
	}
}
...
// newDeploymentNamespaceLister returns a new listersappsv1.DeploymentNamespaceLister.
func newDeploymentNamespaceLister(indexer kcplisters.ResourceIndexer[*appsv1.Deployment], namespace string) listersappsv1.DeploymentNamespaceLister {
	return &deploymentNamespaceLister{
		kcplisters.NewNamespaced(indexer, namespace),
	}
}

// NewDeploymentLister returns a new listersappsv1.DeploymentLister.
// We assume that the indexer:
...
func NewDeploymentLister(indexer cache.Indexer) listersappsv1.DeploymentLister {
	return &deploymentScopedLister{
		listers.New[*appsv1.Deployment](indexer, appsv1.Resource("deployment")),
		indexer,
	}
}
...
// Deployments returns an object that can list and get Deployments in one namespace.
func (l *deploymentScopedLister) Deployments(namespace string) listersappsv1.DeploymentNamespaceLister {
