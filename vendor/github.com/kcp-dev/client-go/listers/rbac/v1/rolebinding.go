...
func (l *roleBindingClusterLister) Cluster(clusterName logicalcluster.Name) listersrbacv1.RoleBindingLister {
	return &roleBindingLister{
		kcplisters.New[*rbacv1.RoleBinding](l.indexer, clusterName, rbacv1.Resource("rolebinding")),
		l.indexer,
		clusterName,
	}
}
...
// newRoleBindingNamespaceLister returns a new listersrbacv1.RoleBindingNamespaceLister.
func newRoleBindingNamespaceLister(indexer kcplisters.ResourceIndexer[*rbacv1.RoleBinding], namespace string) listersrbacv1.RoleBindingNamespaceLister {
	return &roleBindingNamespaceLister{
		kcplisters.NewNamespaced(indexer, namespace),
	}
}

// NewRoleBindingLister returns a new listersrbacv1.RoleBindingLister.
// We assume that the indexer:
...
func NewRoleBindingLister(indexer cache.Indexer) listersrbacv1.RoleBindingLister {
	return &roleBindingScopedLister{
		listers.New[*rbacv1.RoleBinding](indexer, rbacv1.Resource("rolebinding")),
		indexer,
	}
}
...
// RoleBindings returns an object that can list and get RoleBindings in one namespace.
func (l *roleBindingScopedLister) RoleBindings(namespace string) listersrbacv1.RoleBindingNamespaceLister {
