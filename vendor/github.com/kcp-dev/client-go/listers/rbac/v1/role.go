...
func (l *roleClusterLister) Cluster(clusterName logicalcluster.Name) listersrbacv1.RoleLister {
	return &roleLister{
		kcplisters.New[*rbacv1.Role](l.indexer, clusterName, rbacv1.Resource("role")),
		l.indexer,
		clusterName,
	}
}
...
// newRoleNamespaceLister returns a new listersrbacv1.RoleNamespaceLister.
func newRoleNamespaceLister(indexer kcplisters.ResourceIndexer[*rbacv1.Role], namespace string) listersrbacv1.RoleNamespaceLister {
	return &roleNamespaceLister{
		kcplisters.NewNamespaced(indexer, namespace),
	}
}

// NewRoleLister returns a new listersrbacv1.RoleLister.
// We assume that the indexer:
...
func NewRoleLister(indexer cache.Indexer) listersrbacv1.RoleLister {
	return &roleScopedLister{
		listers.New[*rbacv1.Role](indexer, rbacv1.Resource("role")),
		indexer,
	}
}
...
// Roles returns an object that can list and get Roles in one namespace.
func (l *roleScopedLister) Roles(namespace string) listersrbacv1.RoleNamespaceLister {
