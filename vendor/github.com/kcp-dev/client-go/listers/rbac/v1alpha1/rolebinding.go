...
func (l *roleBindingClusterLister) Cluster(clusterName logicalcluster.Name) listersrbacv1alpha1.RoleBindingLister {
	return &roleBindingLister{
		kcplisters.New[*rbacv1alpha1.RoleBinding](l.indexer, clusterName, rbacv1alpha1.Resource("rolebinding")),
		l.indexer,
		clusterName,
	}
}
...
func (l *roleBindingLister) RoleBindings(namespace string) listersrbacv1alpha1.RoleBindingNamespaceLister {
	return newRoleBindingNamespaceLister(l.ResourceIndexer, namespace)
}
...
// newRoleBindingNamespaceLister returns a new listersrbacv1alpha1.RoleBindingNamespaceLister.
func newRoleBindingNamespaceLister(indexer kcplisters.ResourceIndexer[*rbacv1alpha1.RoleBinding], namespace string) listersrbacv1alpha1.RoleBindingNamespaceLister {
	return &roleBindingNamespaceLister{
		kcplisters.NewNamespaced(indexer, namespace),
	}
}

// NewRoleBindingLister returns a new listersrbacv1alpha1.RoleBindingLister.
// We assume that the indexer:
// - is fed by a workspace-scoped LIST+WATCH
// - uses cache.MetaNamespaceKeyFunc as the key function
// - has the cache.NamespaceIndex as an index
func NewRoleBindingLister(indexer cache.Indexer) listersrbacv1alpha1.RoleBindingLister {
	return &roleBindingScopedLister{
		listers.New[*rbacv1alpha1.RoleBinding](indexer, rbacv1alpha1.Resource("rolebinding")),
		indexer,
	}
}
...
// RoleBindings returns an object that can list and get RoleBindings in one namespace.
func (l *roleBindingScopedLister) RoleBindings(namespace string) listersrbacv1alpha1.RoleBindingNamespaceLister {
