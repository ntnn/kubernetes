...
func (l *clusterRoleBindingClusterLister) Cluster(clusterName logicalcluster.Name) listersrbacv1alpha1.ClusterRoleBindingLister {
	return &clusterRoleBindingLister{
		kcplisters.New[*rbacv1alpha1.ClusterRoleBinding](l.indexer, clusterName, rbacv1alpha1.Resource("clusterrolebinding")),
		l.indexer,
		clusterName,
	}
}
...
// NewClusterRoleBindingLister returns a new listersrbacv1alpha1.ClusterRoleBindingLister.
// We assume that the indexer:
// - is fed by a workspace-scoped LIST+WATCH
// - uses cache.MetaNamespaceKeyFunc as the key function
func NewClusterRoleBindingLister(indexer cache.Indexer) listersrbacv1alpha1.ClusterRoleBindingLister {
	return &clusterRoleBindingScopedLister{
		listers.New[*rbacv1alpha1.ClusterRoleBinding](indexer, rbacv1alpha1.Resource("clusterrolebinding")),
		indexer,
	}
}
