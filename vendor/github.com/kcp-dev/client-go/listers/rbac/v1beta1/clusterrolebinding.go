...
func (l *clusterRoleBindingClusterLister) Cluster(clusterName logicalcluster.Name) listersrbacv1beta1.ClusterRoleBindingLister {
	return &clusterRoleBindingLister{
		kcplisters.New[*rbacv1beta1.ClusterRoleBinding](l.indexer, clusterName, rbacv1beta1.Resource("clusterrolebinding")),
		l.indexer,
		clusterName,
	}
}
...
// NewClusterRoleBindingLister returns a new listersrbacv1beta1.ClusterRoleBindingLister.
// We assume that the indexer:
...
func NewClusterRoleBindingLister(indexer cache.Indexer) listersrbacv1beta1.ClusterRoleBindingLister {
	return &clusterRoleBindingScopedLister{
		listers.New[*rbacv1beta1.ClusterRoleBinding](indexer, rbacv1beta1.Resource("clusterrolebinding")),
		indexer,
	}
}
