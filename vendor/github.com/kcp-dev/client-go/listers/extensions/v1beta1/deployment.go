...
func (l *deploymentClusterLister) Cluster(clusterName logicalcluster.Name) listersextensionsv1beta1.DeploymentLister {
	return &deploymentLister{
		kcplisters.New[*extensionsv1beta1.Deployment](l.indexer, clusterName, extensionsv1beta1.Resource("deployment")),
		l.indexer,
		clusterName,
	}
}
...
func (l *deploymentLister) Deployments(namespace string) listersextensionsv1beta1.DeploymentNamespaceLister {
	return newDeploymentNamespaceLister(l.ResourceIndexer, namespace)
}
...
// newDeploymentNamespaceLister returns a new listersextensionsv1beta1.DeploymentNamespaceLister.
func newDeploymentNamespaceLister(indexer kcplisters.ResourceIndexer[*extensionsv1beta1.Deployment], namespace string) listersextensionsv1beta1.DeploymentNamespaceLister {
	return &deploymentNamespaceLister{
		kcplisters.NewNamespaced(indexer, namespace),
	}
}

// NewDeploymentLister returns a new listersextensionsv1beta1.DeploymentLister.
// We assume that the indexer:
// - is fed by a workspace-scoped LIST+WATCH
// - uses cache.MetaNamespaceKeyFunc as the key function
// - has the cache.NamespaceIndex as an index
func NewDeploymentLister(indexer cache.Indexer) listersextensionsv1beta1.DeploymentLister {
	return &deploymentScopedLister{
		listers.New[*extensionsv1beta1.Deployment](indexer, extensionsv1beta1.Resource("deployment")),
		indexer,
	}
}
...
// Deployments returns an object that can list and get Deployments in one namespace.
func (l *deploymentScopedLister) Deployments(namespace string) listersextensionsv1beta1.DeploymentNamespaceLister {
