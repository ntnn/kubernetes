...
func (l *ingressClusterLister) Cluster(clusterName logicalcluster.Name) listersextensionsv1beta1.IngressLister {
	return &ingressLister{
		kcplisters.New[*extensionsv1beta1.Ingress](l.indexer, clusterName, extensionsv1beta1.Resource("ingress")),
		l.indexer,
		clusterName,
	}
}
...
// newIngressNamespaceLister returns a new listersextensionsv1beta1.IngressNamespaceLister.
func newIngressNamespaceLister(indexer kcplisters.ResourceIndexer[*extensionsv1beta1.Ingress], namespace string) listersextensionsv1beta1.IngressNamespaceLister {
	return &ingressNamespaceLister{
		kcplisters.NewNamespaced(indexer, namespace),
	}
}

// NewIngressLister returns a new listersextensionsv1beta1.IngressLister.
// We assume that the indexer:
...
func NewIngressLister(indexer cache.Indexer) listersextensionsv1beta1.IngressLister {
	return &ingressScopedLister{
		listers.New[*extensionsv1beta1.Ingress](indexer, extensionsv1beta1.Resource("ingress")),
		indexer,
	}
}
...
// Ingresses returns an object that can list and get Ingresses in one namespace.
func (l *ingressScopedLister) Ingresses(namespace string) listersextensionsv1beta1.IngressNamespaceLister {
