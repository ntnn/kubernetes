...
func (l *replicaSetClusterLister) Cluster(clusterName logicalcluster.Name) listersextensionsv1beta1.ReplicaSetLister {
	return &replicaSetLister{
		kcplisters.New[*extensionsv1beta1.ReplicaSet](l.indexer, clusterName, extensionsv1beta1.Resource("replicaset")),
		l.indexer,
		clusterName,
	}
}
...
// newReplicaSetNamespaceLister returns a new listersextensionsv1beta1.ReplicaSetNamespaceLister.
func newReplicaSetNamespaceLister(indexer kcplisters.ResourceIndexer[*extensionsv1beta1.ReplicaSet], namespace string) listersextensionsv1beta1.ReplicaSetNamespaceLister {
	return &replicaSetNamespaceLister{
		kcplisters.NewNamespaced(indexer, namespace),
	}
}

// NewReplicaSetLister returns a new listersextensionsv1beta1.ReplicaSetLister.
// We assume that the indexer:
...
func NewReplicaSetLister(indexer cache.Indexer) listersextensionsv1beta1.ReplicaSetLister {
	return &replicaSetScopedLister{
		listers.New[*extensionsv1beta1.ReplicaSet](indexer, extensionsv1beta1.Resource("replicaset")),
		indexer,
	}
}
...
// ReplicaSets returns an object that can list and get ReplicaSets in one namespace.
func (l *replicaSetScopedLister) ReplicaSets(namespace string) listersextensionsv1beta1.ReplicaSetNamespaceLister {
