...
func (l *endpointSliceClusterLister) Cluster(clusterName logicalcluster.Name) listersdiscoveryv1.EndpointSliceLister {
	return &endpointSliceLister{
		kcplisters.New[*discoveryv1.EndpointSlice](l.indexer, clusterName, discoveryv1.Resource("endpointslice")),
		l.indexer,
		clusterName,
	}
}
...
// newEndpointSliceNamespaceLister returns a new listersdiscoveryv1.EndpointSliceNamespaceLister.
func newEndpointSliceNamespaceLister(indexer kcplisters.ResourceIndexer[*discoveryv1.EndpointSlice], namespace string) listersdiscoveryv1.EndpointSliceNamespaceLister {
	return &endpointSliceNamespaceLister{
		kcplisters.NewNamespaced(indexer, namespace),
	}
}

// NewEndpointSliceLister returns a new listersdiscoveryv1.EndpointSliceLister.
// We assume that the indexer:
...
func NewEndpointSliceLister(indexer cache.Indexer) listersdiscoveryv1.EndpointSliceLister {
	return &endpointSliceScopedLister{
		listers.New[*discoveryv1.EndpointSlice](indexer, discoveryv1.Resource("endpointslice")),
		indexer,
	}
}
...
// EndpointSlices returns an object that can list and get EndpointSlices in one namespace.
func (l *endpointSliceScopedLister) EndpointSlices(namespace string) listersdiscoveryv1.EndpointSliceNamespaceLister {
