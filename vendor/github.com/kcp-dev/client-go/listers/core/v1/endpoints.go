...
func (l *endpointsClusterLister) Cluster(clusterName logicalcluster.Name) listerscorev1.EndpointsLister {
	return &endpointsLister{
		kcplisters.New[*corev1.Endpoints](l.indexer, clusterName, corev1.Resource("endpoints")),
		l.indexer,
		clusterName,
	}
}
...
func (l *endpointsLister) Endpoints(namespace string) listerscorev1.EndpointsNamespaceLister {
	return newEndpointsNamespaceLister(l.ResourceIndexer, namespace)
}
...
// newEndpointsNamespaceLister returns a new listerscorev1.EndpointsNamespaceLister.
func newEndpointsNamespaceLister(indexer kcplisters.ResourceIndexer[*corev1.Endpoints], namespace string) listerscorev1.EndpointsNamespaceLister {
	return &endpointsNamespaceLister{
		kcplisters.NewNamespaced(indexer, namespace),
	}
}

// NewEndpointsLister returns a new listerscorev1.EndpointsLister.
// We assume that the indexer:
// - is fed by a workspace-scoped LIST+WATCH
// - uses cache.MetaNamespaceKeyFunc as the key function
// - has the cache.NamespaceIndex as an index
func NewEndpointsLister(indexer cache.Indexer) listerscorev1.EndpointsLister {
	return &endpointsScopedLister{
		listers.New[*corev1.Endpoints](indexer, corev1.Resource("endpoints")),
		indexer,
	}
}
...
// Endpoints returns an object that can list and get Endpoints in one namespace.
func (l *endpointsScopedLister) Endpoints(namespace string) listerscorev1.EndpointsNamespaceLister {
