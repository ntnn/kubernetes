...
func (l *resourceQuotaClusterLister) Cluster(clusterName logicalcluster.Name) listerscorev1.ResourceQuotaLister {
	return &resourceQuotaLister{
		kcplisters.New[*corev1.ResourceQuota](l.indexer, clusterName, corev1.Resource("resourcequota")),
		l.indexer,
		clusterName,
	}
}
...
func (l *resourceQuotaLister) ResourceQuotas(namespace string) listerscorev1.ResourceQuotaNamespaceLister {
	return newResourceQuotaNamespaceLister(l.ResourceIndexer, namespace)
}
...
// newResourceQuotaNamespaceLister returns a new listerscorev1.ResourceQuotaNamespaceLister.
func newResourceQuotaNamespaceLister(indexer kcplisters.ResourceIndexer[*corev1.ResourceQuota], namespace string) listerscorev1.ResourceQuotaNamespaceLister {
	return &resourceQuotaNamespaceLister{
		kcplisters.NewNamespaced(indexer, namespace),
	}
}

// NewResourceQuotaLister returns a new listerscorev1.ResourceQuotaLister.
// We assume that the indexer:
// - is fed by a workspace-scoped LIST+WATCH
// - uses cache.MetaNamespaceKeyFunc as the key function
// - has the cache.NamespaceIndex as an index
func NewResourceQuotaLister(indexer cache.Indexer) listerscorev1.ResourceQuotaLister {
	return &resourceQuotaScopedLister{
...
// ResourceQuotas returns an object that can list and get ResourceQuotas in one namespace.
func (l *resourceQuotaScopedLister) ResourceQuotas(namespace string) listerscorev1.ResourceQuotaNamespaceLister {
