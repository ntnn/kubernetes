...
func (l *nodeClusterLister) Cluster(clusterName logicalcluster.Name) listerscorev1.NodeLister {
	return &nodeLister{
		kcplisters.New[*corev1.Node](l.indexer, clusterName, corev1.Resource("node")),
		l.indexer,
		clusterName,
	}
}
...
// NewNodeLister returns a new listerscorev1.NodeLister.
// We assume that the indexer:
// - is fed by a workspace-scoped LIST+WATCH
// - uses cache.MetaNamespaceKeyFunc as the key function
func NewNodeLister(indexer cache.Indexer) listerscorev1.NodeLister {
	return &nodeScopedLister{
		listers.New[*corev1.Node](indexer, corev1.Resource("node")),
		indexer,
	}
}
