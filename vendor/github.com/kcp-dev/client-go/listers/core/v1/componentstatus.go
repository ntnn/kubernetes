...
func (l *componentStatusClusterLister) Cluster(clusterName logicalcluster.Name) listerscorev1.ComponentStatusLister {
	return &componentStatusLister{
		kcplisters.New[*corev1.ComponentStatus](l.indexer, clusterName, corev1.Resource("componentstatus")),
		l.indexer,
		clusterName,
	}
}
...
// NewComponentStatusLister returns a new listerscorev1.ComponentStatusLister.
// We assume that the indexer:
// - is fed by a workspace-scoped LIST+WATCH
// - uses cache.MetaNamespaceKeyFunc as the key function
func NewComponentStatusLister(indexer cache.Indexer) listerscorev1.ComponentStatusLister {
	return &componentStatusScopedLister{
		listers.New[*corev1.ComponentStatus](indexer, corev1.Resource("componentstatus")),
		indexer,
	}
}
