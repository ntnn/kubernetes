...
func (l *podTemplateClusterLister) Cluster(clusterName logicalcluster.Name) listerscorev1.PodTemplateLister {
	return &podTemplateLister{
		kcplisters.New[*corev1.PodTemplate](l.indexer, clusterName, corev1.Resource("podtemplate")),
		l.indexer,
		clusterName,
	}
}
...
func (l *podTemplateLister) PodTemplates(namespace string) listerscorev1.PodTemplateNamespaceLister {
	return newPodTemplateNamespaceLister(l.ResourceIndexer, namespace)
}
...
// newPodTemplateNamespaceLister returns a new listerscorev1.PodTemplateNamespaceLister.
func newPodTemplateNamespaceLister(indexer kcplisters.ResourceIndexer[*corev1.PodTemplate], namespace string) listerscorev1.PodTemplateNamespaceLister {
	return &podTemplateNamespaceLister{
		kcplisters.NewNamespaced(indexer, namespace),
	}
}

// NewPodTemplateLister returns a new listerscorev1.PodTemplateLister.
// We assume that the indexer:
// - is fed by a workspace-scoped LIST+WATCH
// - uses cache.MetaNamespaceKeyFunc as the key function
// - has the cache.NamespaceIndex as an index
func NewPodTemplateLister(indexer cache.Indexer) listerscorev1.PodTemplateLister {
	return &podTemplateScopedLister{
		listers.New[*corev1.PodTemplate](indexer, corev1.Resource("podtemplate")),
		indexer,
	}
}
...
// PodTemplates returns an object that can list and get PodTemplates in one namespace.
func (l *podTemplateScopedLister) PodTemplates(namespace string) listerscorev1.PodTemplateNamespaceLister {
