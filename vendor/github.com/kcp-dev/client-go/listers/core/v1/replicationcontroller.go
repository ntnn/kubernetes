...
func (l *replicationControllerClusterLister) Cluster(clusterName logicalcluster.Name) listerscorev1.ReplicationControllerLister {
	return &replicationControllerLister{
		kcplisters.New[*corev1.ReplicationController](l.indexer, clusterName, corev1.Resource("replicationcontroller")),
		l.indexer,
		clusterName,
	}
}
...
func (l *replicationControllerLister) ReplicationControllers(namespace string) listerscorev1.ReplicationControllerNamespaceLister {
	return newReplicationControllerNamespaceLister(l.ResourceIndexer, namespace)
}
...
// newReplicationControllerNamespaceLister returns a new listerscorev1.ReplicationControllerNamespaceLister.
func newReplicationControllerNamespaceLister(indexer kcplisters.ResourceIndexer[*corev1.ReplicationController], namespace string) listerscorev1.ReplicationControllerNamespaceLister {
	return &replicationControllerNamespaceLister{
		kcplisters.NewNamespaced(indexer, namespace),
	}
}

// NewReplicationControllerLister returns a new listerscorev1.ReplicationControllerLister.
// We assume that the indexer:
...
func NewReplicationControllerLister(indexer cache.Indexer) listerscorev1.ReplicationControllerLister {
	return &replicationControllerScopedLister{
...
// ReplicationControllers returns an object that can list and get ReplicationControllers in one namespace.
func (l *replicationControllerScopedLister) ReplicationControllers(namespace string) listerscorev1.ReplicationControllerNamespaceLister {
