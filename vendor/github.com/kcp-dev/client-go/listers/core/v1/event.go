...
func (l *eventClusterLister) Cluster(clusterName logicalcluster.Name) listerscorev1.EventLister {
	return &eventLister{
		kcplisters.New[*corev1.Event](l.indexer, clusterName, corev1.Resource("event")),
		l.indexer,
		clusterName,
	}
}
...
// newEventNamespaceLister returns a new listerscorev1.EventNamespaceLister.
func newEventNamespaceLister(indexer kcplisters.ResourceIndexer[*corev1.Event], namespace string) listerscorev1.EventNamespaceLister {
	return &eventNamespaceLister{
		kcplisters.NewNamespaced(indexer, namespace),
	}
}

// NewEventLister returns a new listerscorev1.EventLister.
// We assume that the indexer:
...
func NewEventLister(indexer cache.Indexer) listerscorev1.EventLister {
	return &eventScopedLister{
		listers.New[*corev1.Event](indexer, corev1.Resource("event")),
		indexer,
	}
}
...
// Events returns an object that can list and get Events in one namespace.
func (l *eventScopedLister) Events(namespace string) listerscorev1.EventNamespaceLister {
