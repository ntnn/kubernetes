...
func (l *persistentVolumeClaimClusterLister) Cluster(clusterName logicalcluster.Name) listerscorev1.PersistentVolumeClaimLister {
	return &persistentVolumeClaimLister{
		kcplisters.New[*corev1.PersistentVolumeClaim](l.indexer, clusterName, corev1.Resource("persistentvolumeclaim")),
		l.indexer,
		clusterName,
	}
}
...
func (l *persistentVolumeClaimLister) PersistentVolumeClaims(namespace string) listerscorev1.PersistentVolumeClaimNamespaceLister {
	return newPersistentVolumeClaimNamespaceLister(l.ResourceIndexer, namespace)
}
...
// newPersistentVolumeClaimNamespaceLister returns a new listerscorev1.PersistentVolumeClaimNamespaceLister.
func newPersistentVolumeClaimNamespaceLister(indexer kcplisters.ResourceIndexer[*corev1.PersistentVolumeClaim], namespace string) listerscorev1.PersistentVolumeClaimNamespaceLister {
	return &persistentVolumeClaimNamespaceLister{
		kcplisters.NewNamespaced(indexer, namespace),
	}
}

// NewPersistentVolumeClaimLister returns a new listerscorev1.PersistentVolumeClaimLister.
// We assume that the indexer:
...
func NewPersistentVolumeClaimLister(indexer cache.Indexer) listerscorev1.PersistentVolumeClaimLister {
	return &persistentVolumeClaimScopedLister{
		listers.New[*corev1.PersistentVolumeClaim](indexer, corev1.Resource("persistentvolumeclaim")),
		indexer,
	}
}
...
// PersistentVolumeClaims returns an object that can list and get PersistentVolumeClaims in one namespace.
func (l *persistentVolumeClaimScopedLister) PersistentVolumeClaims(namespace string) listerscorev1.PersistentVolumeClaimNamespaceLister {
