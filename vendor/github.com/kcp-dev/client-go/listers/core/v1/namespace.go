...
func (l *namespaceClusterLister) Cluster(clusterName logicalcluster.Name) listerscorev1.NamespaceLister {
	return &namespaceLister{
		kcplisters.New[*corev1.Namespace](l.indexer, clusterName, corev1.Resource("namespace")),
		l.indexer,
		clusterName,
	}
}
...
// NewNamespaceLister returns a new listerscorev1.NamespaceLister.
// We assume that the indexer:
// - is fed by a workspace-scoped LIST+WATCH
// - uses cache.MetaNamespaceKeyFunc as the key function
func NewNamespaceLister(indexer cache.Indexer) listerscorev1.NamespaceLister {
	return &namespaceScopedLister{
		listers.New[*corev1.Namespace](indexer, corev1.Resource("namespace")),
		indexer,
	}
}
