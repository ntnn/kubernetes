...
func (l *cSINodeClusterLister) Cluster(clusterName logicalcluster.Name) listersstoragev1.CSINodeLister {
	return &cSINodeLister{
		kcplisters.New[*storagev1.CSINode](l.indexer, clusterName, storagev1.Resource("csinode")),
		l.indexer,
		clusterName,
	}
}
...
// NewCSINodeLister returns a new listersstoragev1.CSINodeLister.
// We assume that the indexer:
// - is fed by a workspace-scoped LIST+WATCH
// - uses cache.MetaNamespaceKeyFunc as the key function
func NewCSINodeLister(indexer cache.Indexer) listersstoragev1.CSINodeLister {
	return &cSINodeScopedLister{
		listers.New[*storagev1.CSINode](indexer, storagev1.Resource("csinode")),
		indexer,
	}
}
