...
func (l *volumeAttachmentClusterLister) Cluster(clusterName logicalcluster.Name) listersstoragev1.VolumeAttachmentLister {
	return &volumeAttachmentLister{
		kcplisters.New[*storagev1.VolumeAttachment](l.indexer, clusterName, storagev1.Resource("volumeattachment")),
		l.indexer,
		clusterName,
	}
}
...
// NewVolumeAttachmentLister returns a new listersstoragev1.VolumeAttachmentLister.
// We assume that the indexer:
...
func NewVolumeAttachmentLister(indexer cache.Indexer) listersstoragev1.VolumeAttachmentLister {
	return &volumeAttachmentScopedLister{
		listers.New[*storagev1.VolumeAttachment](indexer, storagev1.Resource("volumeattachment")),
		indexer,
	}
}
