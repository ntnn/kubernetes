...
func (l *storageClassClusterLister) Cluster(clusterName logicalcluster.Name) listersstoragev1.StorageClassLister {
	return &storageClassLister{
		kcplisters.New[*storagev1.StorageClass](l.indexer, clusterName, storagev1.Resource("storageclass")),
		l.indexer,
		clusterName,
	}
}
...
// NewStorageClassLister returns a new listersstoragev1.StorageClassLister.
// We assume that the indexer:
...
func NewStorageClassLister(indexer cache.Indexer) listersstoragev1.StorageClassLister {
	return &storageClassScopedLister{
		listers.New[*storagev1.StorageClass](indexer, storagev1.Resource("storageclass")),
		indexer,
	}
}
