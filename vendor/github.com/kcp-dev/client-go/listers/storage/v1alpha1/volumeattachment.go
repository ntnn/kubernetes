...
func (l *volumeAttachmentClusterLister) Cluster(clusterName logicalcluster.Name) listersstoragev1alpha1.VolumeAttachmentLister {
	return &volumeAttachmentLister{
		kcplisters.New[*storagev1alpha1.VolumeAttachment](l.indexer, clusterName, storagev1alpha1.Resource("volumeattachment")),
		l.indexer,
		clusterName,
	}
}
...
// NewVolumeAttachmentLister returns a new listersstoragev1alpha1.VolumeAttachmentLister.
// We assume that the indexer:
// - is fed by a workspace-scoped LIST+WATCH
// - uses cache.MetaNamespaceKeyFunc as the key function
func NewVolumeAttachmentLister(indexer cache.Indexer) listersstoragev1alpha1.VolumeAttachmentLister {
	return &volumeAttachmentScopedLister{
		listers.New[*storagev1alpha1.VolumeAttachment](indexer, storagev1alpha1.Resource("volumeattachment")),
		indexer,
	}
}
