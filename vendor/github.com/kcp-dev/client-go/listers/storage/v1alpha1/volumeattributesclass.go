...
func (l *volumeAttributesClassClusterLister) Cluster(clusterName logicalcluster.Name) listersstoragev1alpha1.VolumeAttributesClassLister {
	return &volumeAttributesClassLister{
		kcplisters.New[*storagev1alpha1.VolumeAttributesClass](l.indexer, clusterName, storagev1alpha1.Resource("volumeattributesclass")),
		l.indexer,
		clusterName,
	}
}
...
// NewVolumeAttributesClassLister returns a new listersstoragev1alpha1.VolumeAttributesClassLister.
// We assume that the indexer:
...
func NewVolumeAttributesClassLister(indexer cache.Indexer) listersstoragev1alpha1.VolumeAttributesClassLister {
	return &volumeAttributesClassScopedLister{
		listers.New[*storagev1alpha1.VolumeAttributesClass](indexer, storagev1alpha1.Resource("volumeattributesclass")),
		indexer,
	}
}
