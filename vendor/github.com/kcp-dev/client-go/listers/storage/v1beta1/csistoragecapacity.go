...
func (l *cSIStorageCapacityClusterLister) Cluster(clusterName logicalcluster.Name) listersstoragev1beta1.CSIStorageCapacityLister {
	return &cSIStorageCapacityLister{
		kcplisters.New[*storagev1beta1.CSIStorageCapacity](l.indexer, clusterName, storagev1beta1.Resource("csistoragecapacity")),
		l.indexer,
		clusterName,
	}
}
...
// newCSIStorageCapacityNamespaceLister returns a new listersstoragev1beta1.CSIStorageCapacityNamespaceLister.
func newCSIStorageCapacityNamespaceLister(indexer kcplisters.ResourceIndexer[*storagev1beta1.CSIStorageCapacity], namespace string) listersstoragev1beta1.CSIStorageCapacityNamespaceLister {
	return &cSIStorageCapacityNamespaceLister{
		kcplisters.NewNamespaced(indexer, namespace),
	}
}

// NewCSIStorageCapacityLister returns a new listersstoragev1beta1.CSIStorageCapacityLister.
// We assume that the indexer:
...
func NewCSIStorageCapacityLister(indexer cache.Indexer) listersstoragev1beta1.CSIStorageCapacityLister {
	return &cSIStorageCapacityScopedLister{
		listers.New[*storagev1beta1.CSIStorageCapacity](indexer, storagev1beta1.Resource("csistoragecapacity")),
		indexer,
	}
}
...
// CSIStorageCapacities returns an object that can list and get CSIStorageCapacities in one namespace.
func (l *cSIStorageCapacityScopedLister) CSIStorageCapacities(namespace string) listersstoragev1beta1.CSIStorageCapacityNamespaceLister {
