...
func (l *cSINodeClusterLister) Cluster(clusterName logicalcluster.Name) listersstoragev1beta1.CSINodeLister {
	return &cSINodeLister{
		kcplisters.New[*storagev1beta1.CSINode](l.indexer, clusterName, storagev1beta1.Resource("csinode")),
		l.indexer,
		clusterName,
	}
}
...
// NewCSINodeLister returns a new listersstoragev1beta1.CSINodeLister.
// We assume that the indexer:
// - is fed by a workspace-scoped LIST+WATCH
// - uses cache.MetaNamespaceKeyFunc as the key function
func NewCSINodeLister(indexer cache.Indexer) listersstoragev1beta1.CSINodeLister {
	return &cSINodeScopedLister{
		listers.New[*storagev1beta1.CSINode](indexer, storagev1beta1.Resource("csinode")),
		indexer,
	}
}
