...
func (l *storageClassClusterLister) Cluster(clusterName logicalcluster.Name) listersstoragev1beta1.StorageClassLister {
	return &storageClassLister{
		kcplisters.New[*storagev1beta1.StorageClass](l.indexer, clusterName, storagev1beta1.Resource("storageclass")),
		l.indexer,
		clusterName,
	}
}
...
// NewStorageClassLister returns a new listersstoragev1beta1.StorageClassLister.
// We assume that the indexer:
// - is fed by a workspace-scoped LIST+WATCH
// - uses cache.MetaNamespaceKeyFunc as the key function
func NewStorageClassLister(indexer cache.Indexer) listersstoragev1beta1.StorageClassLister {
	return &storageClassScopedLister{
		listers.New[*storagev1beta1.StorageClass](indexer, storagev1beta1.Resource("storageclass")),
		indexer,
	}
}
