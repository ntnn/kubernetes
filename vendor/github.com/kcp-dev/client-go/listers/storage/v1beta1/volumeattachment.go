...
func (l *volumeAttachmentClusterLister) Cluster(clusterName logicalcluster.Name) listersstoragev1beta1.VolumeAttachmentLister {
	return &volumeAttachmentLister{
		kcplisters.New[*storagev1beta1.VolumeAttachment](l.indexer, clusterName, storagev1beta1.Resource("volumeattachment")),
		l.indexer,
		clusterName,
	}
}
...
// NewVolumeAttachmentLister returns a new listersstoragev1beta1.VolumeAttachmentLister.
// We assume that the indexer:
...
func NewVolumeAttachmentLister(indexer cache.Indexer) listersstoragev1beta1.VolumeAttachmentLister {
	return &volumeAttachmentScopedLister{
		listers.New[*storagev1beta1.VolumeAttachment](indexer, storagev1beta1.Resource("volumeattachment")),
		indexer,
	}
}
