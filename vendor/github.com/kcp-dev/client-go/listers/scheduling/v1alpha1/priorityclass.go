...
func (l *priorityClassClusterLister) Cluster(clusterName logicalcluster.Name) listersschedulingv1alpha1.PriorityClassLister {
	return &priorityClassLister{
		kcplisters.New[*schedulingv1alpha1.PriorityClass](l.indexer, clusterName, schedulingv1alpha1.Resource("priorityclass")),
		l.indexer,
		clusterName,
	}
}
...
// NewPriorityClassLister returns a new listersschedulingv1alpha1.PriorityClassLister.
// We assume that the indexer:
// - is fed by a workspace-scoped LIST+WATCH
// - uses cache.MetaNamespaceKeyFunc as the key function
func NewPriorityClassLister(indexer cache.Indexer) listersschedulingv1alpha1.PriorityClassLister {
	return &priorityClassScopedLister{
		listers.New[*schedulingv1alpha1.PriorityClass](indexer, schedulingv1alpha1.Resource("priorityclass")),
		indexer,
	}
}
