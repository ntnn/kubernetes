...
func (l *priorityClassClusterLister) Cluster(clusterName logicalcluster.Name) listersschedulingv1.PriorityClassLister {
	return &priorityClassLister{
		kcplisters.New[*schedulingv1.PriorityClass](l.indexer, clusterName, schedulingv1.Resource("priorityclass")),
		l.indexer,
		clusterName,
	}
}
...
// NewPriorityClassLister returns a new listersschedulingv1.PriorityClassLister.
// We assume that the indexer:
...
func NewPriorityClassLister(indexer cache.Indexer) listersschedulingv1.PriorityClassLister {
	return &priorityClassScopedLister{
		listers.New[*schedulingv1.PriorityClass](indexer, schedulingv1.Resource("priorityclass")),
		indexer,
	}
}
