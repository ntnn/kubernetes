...
func (l *priorityClassClusterLister) Cluster(clusterName logicalcluster.Name) listersschedulingv1beta1.PriorityClassLister {
	return &priorityClassLister{
		kcplisters.New[*schedulingv1beta1.PriorityClass](l.indexer, clusterName, schedulingv1beta1.Resource("priorityclass")),
		l.indexer,
		clusterName,
	}
}
...
// NewPriorityClassLister returns a new listersschedulingv1beta1.PriorityClassLister.
// We assume that the indexer:
...
func NewPriorityClassLister(indexer cache.Indexer) listersschedulingv1beta1.PriorityClassLister {
	return &priorityClassScopedLister{
		listers.New[*schedulingv1beta1.PriorityClass](indexer, schedulingv1beta1.Resource("priorityclass")),
		indexer,
	}
}
