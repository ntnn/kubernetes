...
func (l *serviceCIDRClusterLister) Cluster(clusterName logicalcluster.Name) listersnetworkingv1alpha1.ServiceCIDRLister {
	return &serviceCIDRLister{
		kcplisters.New[*networkingv1alpha1.ServiceCIDR](l.indexer, clusterName, networkingv1alpha1.Resource("servicecidr")),
		l.indexer,
		clusterName,
	}
}
...
// NewServiceCIDRLister returns a new listersnetworkingv1alpha1.ServiceCIDRLister.
// We assume that the indexer:
// - is fed by a workspace-scoped LIST+WATCH
// - uses cache.MetaNamespaceKeyFunc as the key function
func NewServiceCIDRLister(indexer cache.Indexer) listersnetworkingv1alpha1.ServiceCIDRLister {
	return &serviceCIDRScopedLister{
		listers.New[*networkingv1alpha1.ServiceCIDR](indexer, networkingv1alpha1.Resource("servicecidr")),
		indexer,
	}
}
