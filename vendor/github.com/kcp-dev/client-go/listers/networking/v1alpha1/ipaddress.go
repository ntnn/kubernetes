...
func (l *iPAddressClusterLister) Cluster(clusterName logicalcluster.Name) listersnetworkingv1alpha1.IPAddressLister {
	return &iPAddressLister{
		kcplisters.New[*networkingv1alpha1.IPAddress](l.indexer, clusterName, networkingv1alpha1.Resource("ipaddress")),
		l.indexer,
		clusterName,
	}
}
...
// NewIPAddressLister returns a new listersnetworkingv1alpha1.IPAddressLister.
// We assume that the indexer:
// - is fed by a workspace-scoped LIST+WATCH
// - uses cache.MetaNamespaceKeyFunc as the key function
func NewIPAddressLister(indexer cache.Indexer) listersnetworkingv1alpha1.IPAddressLister {
	return &iPAddressScopedLister{
		listers.New[*networkingv1alpha1.IPAddress](indexer, networkingv1alpha1.Resource("ipaddress")),
		indexer,
	}
}
