...
func (l *iPAddressClusterLister) Cluster(clusterName logicalcluster.Name) listersnetworkingv1beta1.IPAddressLister {
	return &iPAddressLister{
		kcplisters.New[*networkingv1beta1.IPAddress](l.indexer, clusterName, networkingv1beta1.Resource("ipaddress")),
		l.indexer,
		clusterName,
	}
}
...
// NewIPAddressLister returns a new listersnetworkingv1beta1.IPAddressLister.
// We assume that the indexer:
...
func NewIPAddressLister(indexer cache.Indexer) listersnetworkingv1beta1.IPAddressLister {
	return &iPAddressScopedLister{
		listers.New[*networkingv1beta1.IPAddress](indexer, networkingv1beta1.Resource("ipaddress")),
		indexer,
	}
}
