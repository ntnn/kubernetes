...
func (l *serviceCIDRClusterLister) Cluster(clusterName logicalcluster.Name) listersnetworkingv1beta1.ServiceCIDRLister {
	return &serviceCIDRLister{
		kcplisters.New[*networkingv1beta1.ServiceCIDR](l.indexer, clusterName, networkingv1beta1.Resource("servicecidr")),
		l.indexer,
		clusterName,
	}
}
...
// NewServiceCIDRLister returns a new listersnetworkingv1beta1.ServiceCIDRLister.
// We assume that the indexer:
...
func NewServiceCIDRLister(indexer cache.Indexer) listersnetworkingv1beta1.ServiceCIDRLister {
	return &serviceCIDRScopedLister{
		listers.New[*networkingv1beta1.ServiceCIDR](indexer, networkingv1beta1.Resource("servicecidr")),
		indexer,
	}
}
