...
func (l *ingressClusterLister) Cluster(clusterName logicalcluster.Name) listersnetworkingv1.IngressLister {
	return &ingressLister{
		kcplisters.New[*networkingv1.Ingress](l.indexer, clusterName, networkingv1.Resource("ingress")),
		l.indexer,
		clusterName,
	}
}
...
// newIngressNamespaceLister returns a new listersnetworkingv1.IngressNamespaceLister.
func newIngressNamespaceLister(indexer kcplisters.ResourceIndexer[*networkingv1.Ingress], namespace string) listersnetworkingv1.IngressNamespaceLister {
	return &ingressNamespaceLister{
		kcplisters.NewNamespaced(indexer, namespace),
	}
}

// NewIngressLister returns a new listersnetworkingv1.IngressLister.
// We assume that the indexer:
...
func NewIngressLister(indexer cache.Indexer) listersnetworkingv1.IngressLister {
	return &ingressScopedLister{
		listers.New[*networkingv1.Ingress](indexer, networkingv1.Resource("ingress")),
		indexer,
	}
}
...
// Ingresses returns an object that can list and get Ingresses in one namespace.
func (l *ingressScopedLister) Ingresses(namespace string) listersnetworkingv1.IngressNamespaceLister {
