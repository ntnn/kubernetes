...
func (l *runtimeClassClusterLister) Cluster(clusterName logicalcluster.Name) listersnodev1alpha1.RuntimeClassLister {
	return &runtimeClassLister{
		kcplisters.New[*nodev1alpha1.RuntimeClass](l.indexer, clusterName, nodev1alpha1.Resource("runtimeclass")),
		l.indexer,
		clusterName,
	}
}
...
// NewRuntimeClassLister returns a new listersnodev1alpha1.RuntimeClassLister.
// We assume that the indexer:
// - is fed by a workspace-scoped LIST+WATCH
// - uses cache.MetaNamespaceKeyFunc as the key function
func NewRuntimeClassLister(indexer cache.Indexer) listersnodev1alpha1.RuntimeClassLister {
	return &runtimeClassScopedLister{
		listers.New[*nodev1alpha1.RuntimeClass](indexer, nodev1alpha1.Resource("runtimeclass")),
		indexer,
	}
}
