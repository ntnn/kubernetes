...
func (l *runtimeClassClusterLister) Cluster(clusterName logicalcluster.Name) listersnodev1beta1.RuntimeClassLister {
	return &runtimeClassLister{
		kcplisters.New[*nodev1beta1.RuntimeClass](l.indexer, clusterName, nodev1beta1.Resource("runtimeclass")),
		l.indexer,
		clusterName,
	}
}
...
// NewRuntimeClassLister returns a new listersnodev1beta1.RuntimeClassLister.
// We assume that the indexer:
...
func NewRuntimeClassLister(indexer cache.Indexer) listersnodev1beta1.RuntimeClassLister {
	return &runtimeClassScopedLister{
		listers.New[*nodev1beta1.RuntimeClass](indexer, nodev1beta1.Resource("runtimeclass")),
		indexer,
	}
}
