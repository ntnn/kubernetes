...
func (l *runtimeClassClusterLister) Cluster(clusterName logicalcluster.Name) listersnodev1.RuntimeClassLister {
	return &runtimeClassLister{
		kcplisters.New[*nodev1.RuntimeClass](l.indexer, clusterName, nodev1.Resource("runtimeclass")),
		l.indexer,
		clusterName,
	}
}
...
// NewRuntimeClassLister returns a new listersnodev1.RuntimeClassLister.
// We assume that the indexer:
...
func NewRuntimeClassLister(indexer cache.Indexer) listersnodev1.RuntimeClassLister {
	return &runtimeClassScopedLister{
		listers.New[*nodev1.RuntimeClass](indexer, nodev1.Resource("runtimeclass")),
		indexer,
	}
}
