...
func (l *priorityLevelConfigurationClusterLister) Cluster(clusterName logicalcluster.Name) listersflowcontrolv1beta3.PriorityLevelConfigurationLister {
	return &priorityLevelConfigurationLister{
		kcplisters.New[*flowcontrolv1beta3.PriorityLevelConfiguration](l.indexer, clusterName, flowcontrolv1beta3.Resource("prioritylevelconfiguration")),
		l.indexer,
		clusterName,
	}
}
...
// NewPriorityLevelConfigurationLister returns a new listersflowcontrolv1beta3.PriorityLevelConfigurationLister.
// We assume that the indexer:
...
func NewPriorityLevelConfigurationLister(indexer cache.Indexer) listersflowcontrolv1beta3.PriorityLevelConfigurationLister {
	return &priorityLevelConfigurationScopedLister{
		listers.New[*flowcontrolv1beta3.PriorityLevelConfiguration](indexer, flowcontrolv1beta3.Resource("prioritylevelconfiguration")),
		indexer,
	}
}
