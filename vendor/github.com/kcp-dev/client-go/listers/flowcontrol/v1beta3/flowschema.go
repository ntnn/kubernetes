...
func (l *flowSchemaClusterLister) Cluster(clusterName logicalcluster.Name) listersflowcontrolv1beta3.FlowSchemaLister {
	return &flowSchemaLister{
		kcplisters.New[*flowcontrolv1beta3.FlowSchema](l.indexer, clusterName, flowcontrolv1beta3.Resource("flowschema")),
		l.indexer,
		clusterName,
	}
}
...
// NewFlowSchemaLister returns a new listersflowcontrolv1beta3.FlowSchemaLister.
// We assume that the indexer:
...
func NewFlowSchemaLister(indexer cache.Indexer) listersflowcontrolv1beta3.FlowSchemaLister {
	return &flowSchemaScopedLister{
		listers.New[*flowcontrolv1beta3.FlowSchema](indexer, flowcontrolv1beta3.Resource("flowschema")),
		indexer,
	}
}
