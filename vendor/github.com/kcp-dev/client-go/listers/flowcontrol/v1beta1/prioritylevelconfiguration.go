...
func (l *priorityLevelConfigurationClusterLister) Cluster(clusterName logicalcluster.Name) listersflowcontrolv1beta1.PriorityLevelConfigurationLister {
	return &priorityLevelConfigurationLister{
		kcplisters.New[*flowcontrolv1beta1.PriorityLevelConfiguration](l.indexer, clusterName, flowcontrolv1beta1.Resource("prioritylevelconfiguration")),
		l.indexer,
		clusterName,
	}
}
...
// NewPriorityLevelConfigurationLister returns a new listersflowcontrolv1beta1.PriorityLevelConfigurationLister.
// We assume that the indexer:
...
func NewPriorityLevelConfigurationLister(indexer cache.Indexer) listersflowcontrolv1beta1.PriorityLevelConfigurationLister {
	return &priorityLevelConfigurationScopedLister{
		listers.New[*flowcontrolv1beta1.PriorityLevelConfiguration](indexer, flowcontrolv1beta1.Resource("prioritylevelconfiguration")),
		indexer,
	}
}
