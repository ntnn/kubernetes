...
func (l *flowSchemaClusterLister) Cluster(clusterName logicalcluster.Name) listersflowcontrolv1beta1.FlowSchemaLister {
	return &flowSchemaLister{
		kcplisters.New[*flowcontrolv1beta1.FlowSchema](l.indexer, clusterName, flowcontrolv1beta1.Resource("flowschema")),
		l.indexer,
		clusterName,
	}
}
...
// NewFlowSchemaLister returns a new listersflowcontrolv1beta1.FlowSchemaLister.
// We assume that the indexer:
...
func NewFlowSchemaLister(indexer cache.Indexer) listersflowcontrolv1beta1.FlowSchemaLister {
	return &flowSchemaScopedLister{
		listers.New[*flowcontrolv1beta1.FlowSchema](indexer, flowcontrolv1beta1.Resource("flowschema")),
		indexer,
	}
}
