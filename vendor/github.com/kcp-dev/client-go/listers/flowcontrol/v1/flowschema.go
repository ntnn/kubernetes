...
func (l *flowSchemaClusterLister) Cluster(clusterName logicalcluster.Name) listersflowcontrolv1.FlowSchemaLister {
	return &flowSchemaLister{
		kcplisters.New[*flowcontrolv1.FlowSchema](l.indexer, clusterName, flowcontrolv1.Resource("flowschema")),
		l.indexer,
		clusterName,
	}
}
...
// NewFlowSchemaLister returns a new listersflowcontrolv1.FlowSchemaLister.
// We assume that the indexer:
...
func NewFlowSchemaLister(indexer cache.Indexer) listersflowcontrolv1.FlowSchemaLister {
	return &flowSchemaScopedLister{
		listers.New[*flowcontrolv1.FlowSchema](indexer, flowcontrolv1.Resource("flowschema")),
		indexer,
	}
}
