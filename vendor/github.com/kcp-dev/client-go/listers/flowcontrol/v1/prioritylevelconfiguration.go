...
func (l *priorityLevelConfigurationClusterLister) Cluster(clusterName logicalcluster.Name) listersflowcontrolv1.PriorityLevelConfigurationLister {
	return &priorityLevelConfigurationLister{
		kcplisters.New[*flowcontrolv1.PriorityLevelConfiguration](l.indexer, clusterName, flowcontrolv1.Resource("prioritylevelconfiguration")),
		l.indexer,
		clusterName,
	}
}
...
// NewPriorityLevelConfigurationLister returns a new listersflowcontrolv1.PriorityLevelConfigurationLister.
// We assume that the indexer:
...
func NewPriorityLevelConfigurationLister(indexer cache.Indexer) listersflowcontrolv1.PriorityLevelConfigurationLister {
	return &priorityLevelConfigurationScopedLister{
		listers.New[*flowcontrolv1.PriorityLevelConfiguration](indexer, flowcontrolv1.Resource("prioritylevelconfiguration")),
		indexer,
	}
}
