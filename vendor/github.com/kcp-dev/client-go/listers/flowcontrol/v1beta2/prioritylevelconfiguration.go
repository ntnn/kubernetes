...
func (l *priorityLevelConfigurationClusterLister) Cluster(clusterName logicalcluster.Name) listersflowcontrolv1beta2.PriorityLevelConfigurationLister {
	return &priorityLevelConfigurationLister{
		kcplisters.New[*flowcontrolv1beta2.PriorityLevelConfiguration](l.indexer, clusterName, flowcontrolv1beta2.Resource("prioritylevelconfiguration")),
		l.indexer,
		clusterName,
	}
}
...
// NewPriorityLevelConfigurationLister returns a new listersflowcontrolv1beta2.PriorityLevelConfigurationLister.
// We assume that the indexer:
...
func NewPriorityLevelConfigurationLister(indexer cache.Indexer) listersflowcontrolv1beta2.PriorityLevelConfigurationLister {
	return &priorityLevelConfigurationScopedLister{
		listers.New[*flowcontrolv1beta2.PriorityLevelConfiguration](indexer, flowcontrolv1beta2.Resource("prioritylevelconfiguration")),
		indexer,
	}
}
