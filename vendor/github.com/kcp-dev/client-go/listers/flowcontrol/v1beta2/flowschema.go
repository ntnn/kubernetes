...
func (l *flowSchemaClusterLister) Cluster(clusterName logicalcluster.Name) listersflowcontrolv1beta2.FlowSchemaLister {
	return &flowSchemaLister{
		kcplisters.New[*flowcontrolv1beta2.FlowSchema](l.indexer, clusterName, flowcontrolv1beta2.Resource("flowschema")),
		l.indexer,
		clusterName,
	}
}
...
// NewFlowSchemaLister returns a new listersflowcontrolv1beta2.FlowSchemaLister.
// We assume that the indexer:
// - is fed by a workspace-scoped LIST+WATCH
// - uses cache.MetaNamespaceKeyFunc as the key function
func NewFlowSchemaLister(indexer cache.Indexer) listersflowcontrolv1beta2.FlowSchemaLister {
	return &flowSchemaScopedLister{
		listers.New[*flowcontrolv1beta2.FlowSchema](indexer, flowcontrolv1beta2.Resource("flowschema")),
		indexer,
	}
}
