...
func (l *resourceSliceClusterLister) Cluster(clusterName logicalcluster.Name) listersresourcev1alpha3.ResourceSliceLister {
	return &resourceSliceLister{
		kcplisters.New[*resourcev1alpha3.ResourceSlice](l.indexer, clusterName, resourcev1alpha3.Resource("resourceslice")),
		l.indexer,
		clusterName,
	}
}
...
// NewResourceSliceLister returns a new listersresourcev1alpha3.ResourceSliceLister.
// We assume that the indexer:
// - is fed by a workspace-scoped LIST+WATCH
// - uses cache.MetaNamespaceKeyFunc as the key function
func NewResourceSliceLister(indexer cache.Indexer) listersresourcev1alpha3.ResourceSliceLister {
	return &resourceSliceScopedLister{
		listers.New[*resourcev1alpha3.ResourceSlice](indexer, resourcev1alpha3.Resource("resourceslice")),
		indexer,
	}
}
