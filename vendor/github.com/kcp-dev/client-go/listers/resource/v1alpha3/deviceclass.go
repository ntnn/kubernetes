...
func (l *deviceClassClusterLister) Cluster(clusterName logicalcluster.Name) listersresourcev1alpha3.DeviceClassLister {
	return &deviceClassLister{
		kcplisters.New[*resourcev1alpha3.DeviceClass](l.indexer, clusterName, resourcev1alpha3.Resource("deviceclass")),
		l.indexer,
		clusterName,
	}
}
...
// NewDeviceClassLister returns a new listersresourcev1alpha3.DeviceClassLister.
// We assume that the indexer:
// - is fed by a workspace-scoped LIST+WATCH
// - uses cache.MetaNamespaceKeyFunc as the key function
func NewDeviceClassLister(indexer cache.Indexer) listersresourcev1alpha3.DeviceClassLister {
	return &deviceClassScopedLister{
		listers.New[*resourcev1alpha3.DeviceClass](indexer, resourcev1alpha3.Resource("deviceclass")),
		indexer,
	}
}
