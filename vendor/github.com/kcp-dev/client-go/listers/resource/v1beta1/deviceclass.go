...
func (l *deviceClassClusterLister) Cluster(clusterName logicalcluster.Name) listersresourcev1beta1.DeviceClassLister {
	return &deviceClassLister{
		kcplisters.New[*resourcev1beta1.DeviceClass](l.indexer, clusterName, resourcev1beta1.Resource("deviceclass")),
		l.indexer,
		clusterName,
	}
}
...
// NewDeviceClassLister returns a new listersresourcev1beta1.DeviceClassLister.
// We assume that the indexer:
...
func NewDeviceClassLister(indexer cache.Indexer) listersresourcev1beta1.DeviceClassLister {
	return &deviceClassScopedLister{
		listers.New[*resourcev1beta1.DeviceClass](indexer, resourcev1beta1.Resource("deviceclass")),
		indexer,
	}
}
