...
func (l *resourceSliceClusterLister) Cluster(clusterName logicalcluster.Name) listersresourcev1beta1.ResourceSliceLister {
	return &resourceSliceLister{
		kcplisters.New[*resourcev1beta1.ResourceSlice](l.indexer, clusterName, resourcev1beta1.Resource("resourceslice")),
		l.indexer,
		clusterName,
	}
}
...
// NewResourceSliceLister returns a new listersresourcev1beta1.ResourceSliceLister.
// We assume that the indexer:
...
func NewResourceSliceLister(indexer cache.Indexer) listersresourcev1beta1.ResourceSliceLister {
	return &resourceSliceScopedLister{
		listers.New[*resourcev1beta1.ResourceSlice](indexer, resourcev1beta1.Resource("resourceslice")),
		indexer,
	}
}
