...
func (l *resourceClaimClusterLister) Cluster(clusterName logicalcluster.Name) listersresourcev1beta1.ResourceClaimLister {
	return &resourceClaimLister{
		kcplisters.New[*resourcev1beta1.ResourceClaim](l.indexer, clusterName, resourcev1beta1.Resource("resourceclaim")),
		l.indexer,
		clusterName,
	}
}
...
// newResourceClaimNamespaceLister returns a new listersresourcev1beta1.ResourceClaimNamespaceLister.
func newResourceClaimNamespaceLister(indexer kcplisters.ResourceIndexer[*resourcev1beta1.ResourceClaim], namespace string) listersresourcev1beta1.ResourceClaimNamespaceLister {
	return &resourceClaimNamespaceLister{
		kcplisters.NewNamespaced(indexer, namespace),
	}
}

// NewResourceClaimLister returns a new listersresourcev1beta1.ResourceClaimLister.
// We assume that the indexer:
...
func NewResourceClaimLister(indexer cache.Indexer) listersresourcev1beta1.ResourceClaimLister {
	return &resourceClaimScopedLister{
		listers.New[*resourcev1beta1.ResourceClaim](indexer, resourcev1beta1.Resource("resourceclaim")),
		indexer,
	}
}
...
// ResourceClaims returns an object that can list and get ResourceClaims in one namespace.
func (l *resourceClaimScopedLister) ResourceClaims(namespace string) listersresourcev1beta1.ResourceClaimNamespaceLister {
