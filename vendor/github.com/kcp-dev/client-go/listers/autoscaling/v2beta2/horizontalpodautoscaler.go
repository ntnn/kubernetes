...
func (l *horizontalPodAutoscalerClusterLister) Cluster(clusterName logicalcluster.Name) listersautoscalingv2beta2.HorizontalPodAutoscalerLister {
	return &horizontalPodAutoscalerLister{
		kcplisters.New[*autoscalingv2beta2.HorizontalPodAutoscaler](l.indexer, clusterName, autoscalingv2beta2.Resource("horizontalpodautoscaler")),
		l.indexer,
		clusterName,
	}
}
...
// newHorizontalPodAutoscalerNamespaceLister returns a new listersautoscalingv2beta2.HorizontalPodAutoscalerNamespaceLister.
func newHorizontalPodAutoscalerNamespaceLister(indexer kcplisters.ResourceIndexer[*autoscalingv2beta2.HorizontalPodAutoscaler], namespace string) listersautoscalingv2beta2.HorizontalPodAutoscalerNamespaceLister {
	return &horizontalPodAutoscalerNamespaceLister{
		kcplisters.NewNamespaced(indexer, namespace),
	}
}

// NewHorizontalPodAutoscalerLister returns a new listersautoscalingv2beta2.HorizontalPodAutoscalerLister.
// We assume that the indexer:
...
func NewHorizontalPodAutoscalerLister(indexer cache.Indexer) listersautoscalingv2beta2.HorizontalPodAutoscalerLister {
	return &horizontalPodAutoscalerScopedLister{
		listers.New[*autoscalingv2beta2.HorizontalPodAutoscaler](indexer, autoscalingv2beta2.Resource("horizontalpodautoscaler")),
		indexer,
	}
}
...
// HorizontalPodAutoscalers returns an object that can list and get HorizontalPodAutoscalers in one namespace.
func (l *horizontalPodAutoscalerScopedLister) HorizontalPodAutoscalers(namespace string) listersautoscalingv2beta2.HorizontalPodAutoscalerNamespaceLister {
